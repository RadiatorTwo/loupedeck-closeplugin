namespace Loupedeck.CloseApplicationPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.CloseApplicationPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.CloseApplicationPlugin.Resources.Resource.txt`.
